...
bias_all.final <- do.binary(bias_all, "bait", flag = "all")
bs_all.final <- do.binary(bs_all, "bait", flag = "all")
conspiracy_all.final <- do.binary(conspiracy_all, "bait", flag = "all")
fake_all.final <- do.binary(fake_all, "bait", flag = "all")
hate_all.final <- do.binary(hate_all, "bait", flag = "all")
junksci_all.final <- do.binary(junksci_all, "bait", flag = "all")
satire_all.final <- do.binary(satire_all, "bait", flag = "all")
```
