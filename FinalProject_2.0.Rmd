...
```{r Summary and Statistical Analysis}
...
result = rbind(domain_rank.sum, spam_score.sum, replies_count.sum, participants_count.sum, likes.sum, comments.sum, shares.sum)

result = as.data.frame(result)
colnames(result)[7] <- c("sd")
rownames(result) <- c("Domain Rank","Spam Score","Replies Count","Participants Count", "Likes","Comments","Shares")
library(knitr)
