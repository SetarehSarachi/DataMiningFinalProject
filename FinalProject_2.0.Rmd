...
result_knn1 <- k.fold.cv(model.mat1,'knn1')
result_knn3 <- k.fold.cv(model.mat1,'knn3')
result_knn5 <- k.fold.cv(model.mat1,'knn5')
result_nb <- k.fold.cv(model.mat1,'nb')
result_dtree <- k.fold.cv(model.mat1,'dtree')
result_dtreeprune <- k.fold.cv(model.mat1,'dtreeprune')
result_svm <- k.fold.cv(model.mat1,'svm')
result_svmsig <- k.fold.cv(model.mat1,'svmsig')
result_svmlin <- k.fold.cv(model.mat1,'svmlin')
result_ada <- k.fold.cv(model.mat1,'ada')
```
