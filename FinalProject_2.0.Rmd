...
model.mat.bait_satire <- model.mat.function(bait_satire)

result_lr <- k.fold.cv(model.mat.bait_satire,'lr', get.performance = T)
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_lr))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr")

result_knn1 <- k.fold.cv(model.mat.bait_satire,'knn1')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_knn1))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1")

result_knn3 <- k.fold.cv(model.mat.bait_satire,'knn3')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_knn3))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3')

result_knn5 <- k.fold.cv(model.mat.bait_satire,'knn5')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_knn5))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3', 'knn5')

result_nb <- k.fold.cv(model.mat.bait_satire,'nb')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_nb))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb')

result_dtree <- k.fold.cv(model.mat.bait_satire,'dtree')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_dtree))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree')

result_dtreeprune <- k.fold.cv(model.mat.bait_satire,'dtreeprune')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_dtreeprune))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree', 'dtreeprune')

result_svm <- k.fold.cv(model.mat.bait_satire,'svm')
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, get.predicted(result_svm))
colnames(actual.vs.predicted.bait_satire) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree', 'dtreeprune', 'svm')

final.prediction <- as.data.frame(apply(actual.vs.predicted.bait_satire[,c(2:length(actual.vs.predicted.bait_satire))], 1, mfv))
actual.vs.predicted.bait_satire <- cbind(actual.vs.predicted.bait_satire, final.prediction)
