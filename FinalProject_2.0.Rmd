...
actual.vs.predicted = data.frame(actual = bait_satire$type)

result_lr <- k.fold.cv(model.mat.function(bait_satire),'lr', get.performance = T)
actual.vs.predicted <- cbind(actual.vs.predicted, get.predicted(result_lr))
colnames(actual.vs.predicted) <- c("actual", "lr")

result_knn1 <- k.fold.cv(model.mat.function(bait_satire),'knn1')
actual.vs.predicted <- cbind(actual.vs.predicted, get.predicted(result_knn1))
colnames(actual.vs.predicted) <- c("actual", "lr", "knn1")

result_knn3 <- k.fold.cv(model.mat.function(bait_satire),'knn3')
...
result_knn5 <- k.fold.cv(model.mat.function(bait_satire),'knn5')
...
result_nb <- k.fold.cv(model.mat.function(bait_satire),'nb')
...
result_dtree <- k.fold.cv(model.mat.function(bait_satire),'dtree')
...
result_dtreeprune <- k.fold.cv(model.mat.function(bait_satire),'dtreeprune')
...
result_svm <- k.fold.cv(model.mat.function(bait_satire),'svm')
...
final.prediction <- as.data.frame(apply(actual.vs.predicted[,c(2:length(actual.vs.predicted))], 1, mfv))
...
#result_svmsig <- k.fold.cv(model.mat.function(bait_satire),'svmsig')
#actual.vs.predicted <- cbind(actual.vs.predicted, get.predicted(result_svmsig))
#colnames(actual.vs.predicted) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree', #'dtreeprune', 'svm', 'svmsig')

#result_svmlin <- k.fold.cv(model.mat.function(bait_satire),'svmlin')
#actual.vs.predicted <- cbind(actual.vs.predicted, get.predicted(result_svmlin))
#colnames(actual.vs.predicted) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree', #'dtreeprune', 'svm', 'svmsig', 'svmlin')

#result_ada <- k.fold.cv(model.mat.function(bait_satire),'ada')
#actual.vs.predicted <- cbind(actual.vs.predicted, get.predicted(result_ada))
#colnames(actual.vs.predicted) <- c("actual", "lr", "knn1", 'knn3', 'knn5', 'nb', 'dtree', #'dtreeprune', 'svm', 'svmsig', 'svmlin', 'ada')
